...
COLORREF crItemForeground = 0xFFFFFF;
COLORREF crItemDisabled = 0xAAAAAA;
HBRUSH brBackground = CreateSolidBrush(0x262626);
HBRUSH brItemBackgroundHot = CreateSolidBrush(0x353535);
HBRUSH brItemBackgroundSelected = CreateSolidBrush(0x454545);
HBRUSH brItemBorder = CreateSolidBrush(0x262626);
...
bool CALLBACK UAHWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT* lpResult)
{
    ...
    case WM_UAHDRAWMENUITEM:
    {
        ...
        HBRUSH* pbrBackground = &brBackground;
        HBRUSH* pbrBorder = &brBackground;
        ...
        DTTOPTS opts = { sizeof(opts), DTT_TEXTCOLOR, iTextStateID != MBI_DISABLED ? crItemForeground : crItemDisabled };
